...
const SignupScreen = () => {
  ...
  const initialValues = useMemo(
    () => ({
      firstName: {
        value: "",
        validate: (firstName: FieldValue) => (firstName as string).length < 4,
      },
      lastName: {
        value: "",
        validate: (lastName: FieldValue) => (lastName as string).length < 4,
      },
      email: {
        value: "",
                  ...
                  <div className="w-1/2 px-3 mb-5">
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        placeholder="John"
                        value={fieldValues.firstName as string}
                  ...
                  <div className="w-1/2 px-3 mb-5">
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        className="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-indigo-500"
                        placeholder="Smith"
                        value={fieldValues.lastName as string}
                        onChange={handleInputChange}
                        onBlur={handleInputBlur}
                      />
                    </div>
      ...
      <Dialog
        ...
        content={
          <span className="flex flex-col w-full">
            <span>Creating an account, please wait...</span>
